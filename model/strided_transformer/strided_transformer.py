...
from model.strided_transformer.block.vanilla_transformer_encoder import Transformer
from model.strided_transformer.block.strided_transformer_encoder import Transformer as Transformer_reduce
